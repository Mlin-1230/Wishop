...
<script>
    ...
    function sortByPrice() {
        window.location.href = 'View_Reviews.php?User_id=' + User_id + '&OrderMethod=Product_Name';
    }

    function sortByName() {
        window.location.href = 'View_Reviews.php?User_id=' + User_id + '&OrderMethod=Score';
    }

    function sortByDate() {
        window.location.href = 'View_Reviews.php?User_id=' + User_id + '&OrderMethod=Date';
    }

    function Sort() {
        var COrderDirection = '<?php echo $OrderDirection === "ASC" ? "ASC" : "DESC"; ?>';
        var NOrderDirection = COrderDirection === "ASC" ? "DESC" : "ASC";
        window.location.href = 'View_Reviews.php?User_id=' + User_id + '&OrderMethod=' + OrderMethod + '&OrderDirection=' + NOrderDirection;
    }
</script>
