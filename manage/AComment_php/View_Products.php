...
<script>
    ...
    function sortByPrice() {
        window.location.href = 'View_Products.php?Agent_id=' + Agent_id + '&OrderMethod=Product_Price';
    }

    function sortByName() {
        window.location.href = 'View_Products.php?Agent_id=' + Agent_id + '&OrderMethod=Product_Name';
    }

    function sortByDate() {
        window.location.href = 'View_Products.php?Agent_id=' + Agent_id + '&OrderMethod=UDate';
    }

    function Sort() {
        var COrderDirection = '<?php echo $OrderDirection === "ASC" ? "ASC" : "DESC"; ?>';
        var NOrderDirection = COrderDirection === "ASC" ? "DESC" : "ASC";
        window.location.href = 'View_Products.php?Agent_id=' + Agent_id + '&OrderMethod=' + OrderMethod + '&OrderDirection=' + NOrderDirection;
    }
</script>
